	...
	<div class="container" id="orderform"> <a name="orderform"></a>
		...
		<div class="row">
			...
			<div class="span6" id="orderform_text">
				Для того, чтобы заказать создание сайта, вы можете заполнить эту форму или просто позвонить нам. После того, как вы оставите заявку, наш менеджер свяжется с вами для получения информации  и расчета сметы по созданию вашего сайта.
			</div>
